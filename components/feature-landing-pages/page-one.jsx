...
function PageOne({ parsedFeature }) {
  ...
  return (
    <div className="tw-w-full tw-h-auto tw-bg-white">
      <section className="">
        <div className="container max-w-xl p-6 mx-auto space-y-12 lg:px-8 lg:max-w-7xl">
          ...
          <div className="flex justify-between iteam-">
            <div>
              <h1 className="text-xl font-bold text-left sm:text-3xl text-gray-600">
               {parsedFeature?.herosection?.title}
              </h1>
              <h2 className="w-[50%] mt-3 text-gray-600">
               {parsedFeature?.herosection?.dec}
              </h2>
            </div>
              <form    className='relative flex flex-col md:flex-row items-center mt-8 justify-center ml-auto md:ml-[15%]'>
            <input
              type="text"
              readOnly
        ...
        <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
          <div className="container mx-auto px-6 p-6 bg-white">
            <div className="mb-16 text-center border-b border-gray-900 pb-10">
              <h1 className="mt-2 text-5xl lg:text-3xl font-bold tracking-tight text-gray-900">
      ...
      <h1 className="font-bold text-2xl text-gray-900">{parsedFeature?.FeaturesDataMobile?.title}</h1>
      ...
      {parsedFeature?.FeaturesDataMobile?.features.map((feature) => {
        ...
        <div key={feature.id} className="flex items-start gap-4">
          ...
          <div className="flex justify-center">
            <Image
              src="/Assts/School-Software-Mobile App.png"
              alt="Phone Mockup"
              width={300}
              height={500}
              priority
        ...
        <div className="max-w-7xl mt-16 bg-white h-auto mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center rounded-2xl p-8 shadow-md">
          <div className="flex justify-center">
            <Image
              src="/Assts/School-management-software.png"
              alt="Laptop Mockup"
              width={700}
              height={1200}
              priority
          ...
          <div className="space-y-8">
            ...
            {parsedFeature?.FeaturesDataOfLaptop?.features?.map((feature) => {
              const Icon = feature?.icon;
              return(
              <div key={feature.id} className="flex items-start gap-4">
