...
const NavBar = () => {
    ...
    const isActive = (path) =>
        pathname === path ? "text-[#743DFF] underline underline-offset-4" : "text-black";
    ...
    const menuItems = [
        ...
        },
        {
            key: "2",
            label: (
                <Link href="/testimonials" className={isActive("/testimonials") + " block"}>
                    Testimonials
                </Link>
            ),
        },
    ...
    const aboutUs = [
        ...
        },
        {
            key: "2",
            label: (
                <Link href="/blog-listing" className={isActive("/testimonials") + " block"}>
                    Blogs
                </Link>
            ),
        },
            ...
            <nav>
                <div className="max-w-screen-xl mx-auto px-4 py-3 flex items-center justify-between">
                    ...
                    <Link href="/" className="flex items-center space-x-2">
                        <Image src={mlc} alt="Logo" width={40} height={40} className="rounded-md" />
                ...
                {isMobileMenuOpen && (
                    <div className="xl:hidden bg-white px-6 pt-4 pb-6 space-y-4 text-sm font-medium shadow-md">
                        ...
                        <Link href="/features" className={isActive("/features") + " block"}>
                            Features
                        </Link>
                        <Link href="/clients" className={isActive("/clients") + " block"}>
                            Clients
                        ...
                        <Link href="/pricing" className={isActive("/pricing") + " block"}>
                            Pricing
                        </Link>
                        <Link href="/aboutus" className={isActive("/aboutus") + " block"}>
                            About Us
                        </Link>
                        <a
                            target="_blank"
